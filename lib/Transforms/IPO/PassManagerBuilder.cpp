...
static cl::opt<bool> StringEncryption("xSe", cl::init(false), cl::desc("Enable string encryption"));

static cl::opt<bool>
StringObfuscation("gxse",cl::init(false),cl::desc("Enable string encryptions"));
