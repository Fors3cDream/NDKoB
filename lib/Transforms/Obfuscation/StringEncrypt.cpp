...
#include "llvm/Transforms/Obfuscation/StringEncrypt.h"

using namespace llvm;

StringEncrypt::StringEncrypt(char ID) : ModulePass(ID) {
    
}

bool StringEncrypt::runOnModule(Module &M) {
    bool changed = false;
...
void StringEncrypt::handleLoad(Module &M, LoadInst* Load) {
...
void StringEncrypt::handleCall(llvm::Module &M, llvm::CallInst* Call) {
...
void StringEncrypt::handleInvoke(llvm::Module &M, llvm::InvokeInst* Invoke){
