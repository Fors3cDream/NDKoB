               ...
               private:
                void addDecodeFunction(Module *mod, std::vector<encVar*> *gvars) {
                        ...
                        FunctionType* FuncTy = FunctionType::get(
                          ...
                          /*isVarArg=*/false);
                        Constant* c = mod->getOrInsertFunction(".datadiv_decode", FuncTy);
                        ...
                        for (unsigned i = 0, e = gvars->size(); i != e; ++i) {
                          ...
                          Instruction* ptr_arrayidx = GetElementPtrInst::Create(gvar, ptr_32_indices, "arrayidx", label_for_body);
                                // Load
...
Pass * llvm::createStringObfuscation() {
